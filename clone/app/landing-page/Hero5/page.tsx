    ...
    <div className=" md:flex md:space-x-20 py-20 space-y-10 items-center justify-center bg-[#282828]">
       ...
       <div className=" space-y-6 flex flex-col text-gray-200 md:w-1/3 px-10">
        ...
        <div className="text-xl">
            Connect what needs to get done, who is responsible , and how to 
            public get it done.
            ...
            <AccordionItem value="item-2">
                <AccordionTrigger className="text-blue-400">
                    ...
                    <AccordionContent className="border-b border-blue-500">
                        ...
                        <div className="flex text-lue-400 pt-4">
        ...
        <Image src="/images/tab-6.webp" alt="Image" 
        width={700} height={700} className="p-10" />
