        ...
        <div className="flex py-20">
            <div className='space-y-6 flex flex-col'>
                ...
                <div className="text-xl text-gray-600 px-10">
                    Connect what needs to be done, who is responsible, and how to 
                  get it done 
                ...
                <div className="md:flex items-center md:space-x-60 space-y-10 p-10">
                    ...
                    <div className="space-y-10 border-b">
                        ...
                        <div className="w-96 text-xl text-gray-600">
                            Make it easy for your team to focus on tasks currently at hard.Define each stage to see what is important and where things are getting stuck. 
                        </div>
                        <div className="flex">
