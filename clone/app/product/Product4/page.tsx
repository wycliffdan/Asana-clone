...
const Product4 = () => {
    return (
       ...
       <div className="md:flex md:space-x-10 items-center px-10 justify-end">

        <div className="bg-gradient-to-r from-gray-400 to-gray-100
        items-center justify-center
        rounded-md flex p-10">
            <Image 
        ...
        <div className="flex items-center justify-center py-6 md:w-1/2">
            <div className="text-4xl  flex md: md:space-y-20 space-y-10 flex-col">
                <div>
